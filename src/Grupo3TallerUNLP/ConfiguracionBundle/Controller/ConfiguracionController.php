...
class ConfiguracionController extends Controller
{
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('Grupo3TallerUNLPConfiguracionBundle:Configuracion:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        return $this->render('Grupo3TallerUNLPConfiguracionBundle:Configuracion:show.html.twig', array(
            'entity'      => $entity,
    ...
    */
    ...
    public function updateAction(Request $request, $id)
    {
        ...
        if ($editForm->isValid()) {
            ...
            return $this->redirect($this->generateUrl('configuracion', array('id' => $id)));
        }
